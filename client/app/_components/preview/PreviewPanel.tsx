...
import "../../_lib/styles/pdf-override.css"
...
/*
    ...
    The worker file is copied to client/public/pdf.worker.min.mjs and served
    from /pdf.worker.min.mjs. Using a static public asset (rather than the
    Vite `new URL(..., import.meta.url)` pattern) keeps this Next.js-compatible
        ...
        <div className="flex flex-col h-full">
            ...
            <div className="flex-none flex items-center justify-between gap-2 px-4 py-2.5 bg-white border-b border-slate-200" data-theme="light">
                <div className = "flex flex-row gap-x-4 items-center">
                    ...
                    >
                        <LayoutDashboard className={`w-3.5 h-3.5 ${isTemplatesPaneActive ? "text-brand-medium" : "text-slate-500"}`} />
                        <span>Templates</span>
